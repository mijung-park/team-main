		...
		<div class="b_header_util">
			<div class="inner">
				<div class="c_util_servicelink">
					...
					<ul>
						<li>
							<a href="${appRoot }/main/mainPage" class="" >베스트</a>
						</li>
						<li>
							<a href="${appRoot }/freeboard/list" class="">자유게시판</a>
						</li>
						<li>
							<a href="${appRoot }/qa/list" class="" >Q&A</a>
						</li>
						<li>
							<a href="${appRoot }/rev/list" class="">구매후기</a>
						</li>
						<li>
							<a href="${appRoot }/product/list" class="">상품목록</a>
						</li>
