               ...
               <div class="d-flex">
                     <!-- 상품 뿌려주는 테이블 -->
                        <table class="table table-hover">
                           <thead>
                              <tr>
                                 <th style ="text-align:center"><input type="checkbox" id="allCheck"/>&nbsp; 전체선택</th>
                                 <th style ="text-align:center">상품명</th>
                                 <th style ="text-align:center">상품개수</th>
                                 <th style ="text-align:center">상품금액</th>
                                 <th style ="text-align:center">항목가격</th>
                           ...
                           <c:forEach items="${orderList }" var="order" varStatus="status" >
                              <tr>
                                 <td style ="text-align:center"><p><input type="checkbox" id="inputCheckBox${status.index}" name="checkbox" data-index="${status.index}" value="inputCheckBox${status.index}" /></p></td>
                                 <td>
                                 ...
                                 <td style ="text-align:center"><p>${order.order_quantity } 개</p></td>
                                 <td style ="text-align:center"><p><fmt:formatNumber value='${order.order_poprice * order.order_quantity }' type="number"></fmt:formatNumber>원</p></td>
                                 <td style ="text-align:center"><p><fmt:formatNumber value='${order.order_poprice }' type="number"></fmt:formatNumber>원</p></td>
                                 <td style ="text-align:center"><p> <span id="deliveryPrice">2500</span>원</p></td>
                                 <td hidden="hidden" style ="text-align:center"><p class="requireTotalPrice"></p>
